!program main
!implicit none
!integer,parameter :: nb = 100000, seed=11
!real(8) :: resultat
!real(8):: energies(nb)
!real(8) :: cosangles(nb)
...
!write (22,*) types(ii),energies(ii),cosangles(ii),altitude_list(ii)
...
integer,parameter :: nebin=128 ! number of energy mesh (divided by log)
integer,parameter :: nabin=128 ! number of angle mesh (divided by linear)
integer,parameter :: naltbin=128
