...
#include "G4EmStandardPhysics_option3_dr.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmStandardPhysics_option3_dr);
...
G4EmStandardPhysics_option3_dr::~G4EmStandardPhysics_option3_dr()
{}
