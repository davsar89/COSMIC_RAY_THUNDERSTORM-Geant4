...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4EmStandardPhysics_option1_dr);

// ....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4EmStandardPhysics_option1_dr::G4EmStandardPhysics_option1_dr(G4int ver, const G4String&) : G4VPhysicsConstructor("G4EmStandard_opt1"), verbose(ver)
{
...
G4EmStandardPhysics_option1_dr::~G4EmStandardPhysics_option1_dr()
{}

// ....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4EmStandardPhysics_option1_dr::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void G4EmStandardPhysics_option1_dr::ConstructProcess()
{
  if (verbose > 1)
  {
  ...
  for (const auto& particleName : partList.PartNames())
  {
    ...
    else if (particleName == "e-")
    {
      ...
      eioni->SetStepFunction(settings->drOverR, 1.0 * mm);
    ...
    else if ((particleName == "B+") || (particleName == "B-") || (particleName == "D+") || (particleName == "D-") || (particleName == "Ds+") || (particleName == "Ds-") ||
             (particleName == "anti_He3") || (particleName == "anti_alpha") ||
             (particleName == "anti_deuteron") || (particleName == "anti_lambda_c+") || (particleName == "anti_omega-") || (particleName == "anti_sigma_c+") ||
             (particleName == "anti_sigma_c++") || (particleName == "anti_sigma+") ||
             (particleName == "anti_sigma-") || (particleName == "anti_triton") || (particleName == "anti_xi_c+") || (particleName == "anti_xi-") ||
             (particleName == "deuteron") || (particleName == "lambda_c+") || (particleName == "omega-") ||
             (particleName == "sigma_c+") || (particleName == "sigma_c++") || (particleName == "sigma+") || (particleName == "sigma-") || (particleName == "tau+") ||
             (particleName == "tau-") || (particleName == "triton") || (particleName == "xi_c+") ||
             (particleName == "xi-"))
    {
      ph->RegisterProcess(hmsc,                particle);
      ph->RegisterProcess(new G4hIonisation(), particle);
