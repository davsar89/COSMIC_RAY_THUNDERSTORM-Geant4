...
G4HadronPhysicsFTFP_BERT_LEND::G4HadronPhysicsFTFP_BERT_LEND(G4int)
...
G4HadronPhysicsFTFP_BERT_LEND::G4HadronPhysicsFTFP_BERT_LEND(const G4String &name, G4bool quasiElastic)
