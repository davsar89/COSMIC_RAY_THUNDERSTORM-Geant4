...
mission = 'ALOFT2019';
WANTED_REC_ALT = 20;
MAX_WANTED_INCREASE = 1.45;
MIN_WANTED_INCREASE = 1.1;
...
plot(-RREA_thres_MV+80,profile.altitude,'b','linewidth',8)
...
xticklabels(unique(sort([0 -220:20:220]))-80);
% h = breakxaxis([-10 10]);

% set(gca,'xlim',[130-80 220-80])
...
path_to_folder = '/Home/siv29/dsa030/Desktop/article_cr_modeling/DATA_REPO/ARTICLE_DATA/Figure_45/';
saveas(gcf,[path_to_folder mission '.eps'],'epsc')
saveas(gcf,[path_to_folder mission '.png'],'png')
