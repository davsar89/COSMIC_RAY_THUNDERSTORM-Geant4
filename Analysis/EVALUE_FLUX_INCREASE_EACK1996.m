...
% xticklabels(-1.0*unique(sort([0 -220:20:220])));
...
path_to_folder = '/Home/siv29/dsa030/Desktop/article_cr_modeling/DATA_REPO/ARTICLE_DATA/Figure_4/';
saveas(gcf,[path_to_folder mission '.eps'],'epsc')
saveas(gcf,[path_to_folder mission '.png'],'png')
