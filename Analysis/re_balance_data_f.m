...
% e.g. there can be 3 files for initial photon but 4 files for initial proton; then one initial photon file should be removed
    ...
    for i_efield_s = 1:length(EFIELD_SIZE_list)
        for i_efield_c = 1:length(EFIELD_CENTER_list)
            ...
            for i_alt = 1:length(RECORD_ALTITUDE_LIST)
                ...
                disp(['REC ALTITUDE: ' num2str(SELECTED_RECORD_ALTITUDE)])
                    ...
                    for ii=1:length(dir_list)
                        ...
                        if nb_out_files==3
                            ...
                            try
                                ...
                                disp(['skipped move folder : ' the_folder '/' dir_list{ii}]);
                            end
                        end
                    end
